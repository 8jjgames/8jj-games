        ...
        <div className="footer-mobile-accordions">
          ...
          <div className={`accordion ${open === "browse" ? "open" : ""}`}>
            <div className="accordion-header" onClick={() => toggleAccordion("browse")}>
              ...
              <span className="arrow"><svg className="faq-icon-chevron" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 7.5L10 12.5L15 7.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg></span>
            </div>
